...
class Tokeniser {
    ...
    public char[] consumeCharacterReference(Character additionalAllowedCharacter, boolean inAttribute) {
        ...
        if ((additionalAllowedCharacter != null && additionalAllowedCharacter.charValue() == this.reader.current()) || this.reader.matchesAny(9, 10, TokenParser.CR, 12, TokenParser.SP, '<', '&')) {
            return null;
        }
        this.reader.mark();
