...
public class Document extends Element {
    ...
    public String title() {
        Element titleEl = getElementsByTag(LauncherSettings.BaseLauncherColumns.TITLE).first();
    ...
    public void title(String title) {
        ...
        Element titleEl = getElementsByTag(LauncherSettings.BaseLauncherColumns.TITLE).first();
        if (titleEl == null) {
            head().appendElement(LauncherSettings.BaseLauncherColumns.TITLE).text(title);
        } else {
            titleEl.text(title);
        }
    }
