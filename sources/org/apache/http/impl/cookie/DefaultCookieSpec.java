...
public class DefaultCookieSpec implements CookieSpec {
    ...
    DefaultCookieSpec(RFC2965Spec strict2, RFC2109Spec obsoleteStrict2, NetscapeDraftSpec netscapeDraft2) {
        this.strict = strict2;
        this.obsoleteStrict = obsoleteStrict2;
        this.netscapeDraft = netscapeDraft2;
    }
