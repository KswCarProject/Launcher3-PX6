...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private static class ActionBarDrawerToggleImplIcs implements ActionBarDrawerToggleImpl {
        ...
        public Object setActionBarUpIndicator(Object info, Activity activity, Drawable themeImage, int contentDescRes) {
            return ActionBarDrawerToggleIcs.setActionBarUpIndicator(info, activity, themeImage, contentDescRes);
        }

        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return ActionBarDrawerToggleIcs.setActionBarDescription(info, activity, contentDescRes);
        }
    }
