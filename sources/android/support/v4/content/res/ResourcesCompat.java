...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r19, android.content.res.Resources r20, android.util.TypedValue r21, int r22, int r23, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r24, @android.support.annotation.Nullable android.os.Handler r25, boolean r26) {
        ...
        L_0x0033:
            ...
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = android.support.v4.content.res.FontResourcesParserCompat.parse(r0, r9)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0089 }
            r17 = r1
        ...
        L_0x0097:
            ...
            r13.callbackSuccessAsync(r7, r14)     // Catch:{ XmlPullParserException -> 0x00ab, IOException -> 0x00a9 }
            goto L_0x00b0
        L_0x00a9:
            r0 = move-exception
            goto L_0x005d
        L_0x00ab:
            ...
            goto L_0x0065
        L_0x00ad:
            r13.callbackFailAsync(r10, r14)     // Catch:{ XmlPullParserException -> 0x00ab, IOException -> 0x00a9 }
        L_0x00b0:
            return r7
        L_0x00b1:
            r0 = move-exception
